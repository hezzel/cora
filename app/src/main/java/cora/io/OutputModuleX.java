...
public class OutputModuleX {
   ...
   */
  public OutputModuleX(Printer printer, PageBuilder page, Style style) {
    _printer = printer;
    _page = page;
    _style = style;
    _table = null;
  ...
  public static OutputModuleX createPlainModule(TRS trs) {
    return new OutputModuleX(PrinterFactory.createPlainPrinter(trs),
                            new TextPageBuilder(),
                            Style.Plain);
  }

  /** This creates a module with Unicode style (pure text, but unicode symbols are allowed). */
  public static OutputModuleX createUnicodeModule(TRS trs) {
    return new OutputModuleX(PrinterFactory.createUnicodePrinter(trs),
                            new TextPageBuilder(),
                            Style.Unicode);
  }
   ...
   */
  public static OutputModuleX createUnitTestModule() {
    return new OutputModuleX(PrinterFactory.createPrinterNotForUserOutput(),
                            new TextPageBuilder(),
                            Style.Unicode);
  }
