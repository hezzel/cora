...
public interface Parser {
   ...
   */
  public sealed interface ParserTerm permits Identifier, Lambda, Meta, Application, Tuple,
  ...
  public record Lambda(Token token, String vname, Type type, ParserTerm arg) implements ParserTerm {
    public String toString() {
      return "λ" + vname + "::" + type.toString() + "." + arg.toString();
    }
  ...
  public record Tuple(Token token, ImmutableList<ParserTerm> args) implements ParserTerm {
