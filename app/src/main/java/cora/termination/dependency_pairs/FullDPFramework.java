...
public class FullDPFramework {
  public String queryDisabledCode() { return DPFramework.queryDisabledCode(); }
  public String queryPrivateDisabledCode() { return DPFramework.queryPrivateDisabledCode(); }
  ...
  public DPProofObject proveTermination(TRS trs, boolean ruleExtensionPresent) {
    ...
    Problem initialProblem = computeInitialProblem(trs);
