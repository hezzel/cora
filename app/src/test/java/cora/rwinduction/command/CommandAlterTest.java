...
class CommandAlterTest {
  ...
  public void testMissingName() {
    ...
    assertTrue(module.toString().equals(
      "Unexpected end of input at position 11; I expected a variable name.\n\n" +
      "Unexpected end of input at position 23; I expected a variable name.\n\n"));
  }
  ...
  @Test
  public void testMissingSpacesAroundEquals() {
    OutputModule module = OutputModule.createUnicodeModule(trs);
    assertTrue(createAddStep(module, "alter add a= b + 1").isEmpty());
    assertTrue(createAddStep(module, "alter add a =b + 1").isEmpty());
    assertTrue(createAddStep(module, "alter add a=b + 1").isEmpty());
    assertTrue(module.toString().equals(
      "Unexpected input at position 11.  Please use spaces around the = in this command.\n\n" +
      "Unexpected input at position 13; I expected = but got =b.\n\n" +
      "Unexpected input at position 11.  Please use spaces around the = in this command.\n\n"));
  }
  ...
  @Test
  public void testSuggestionOneNameGiven() {
  ...
  @Test
  public void testSuggestionTermGiven() {
  ...
  @Test
  public void testSuggestionPartialTermGiven() {
    ArrayList<Command.TabSuggestion> suggestions = getSuggestions("add jdka = x + 1 -");
    assertTrue(suggestions.size() == 1);
    assertTrue(suggestions.get(0).text() == null);
    assertTrue(suggestions.get(0).category().equals("term"));
  ...
  @Test
  public void testSuggestionPastComma() {
