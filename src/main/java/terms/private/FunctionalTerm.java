 ...
 */
class FunctionalTerm extends ApplicativeTermInherit {
   ...
   */
  FunctionalTerm(FunctionSymbol f, Term arg) {
    super(f, arg);
    _f = f;
  }
   ...
   */
  FunctionalTerm(FunctionSymbol f, Term arg1, Term arg2) {
    super(f, arg1, arg2);
    _f = f;
  }
   ...
   */
  FunctionalTerm(FunctionSymbol f, List<Term> args) {
    super(f, args);
    _f = f;
  }
