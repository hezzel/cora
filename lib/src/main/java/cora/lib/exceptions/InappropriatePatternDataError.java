 ...
 * different pattern, an InappropriatePatternDataError is thrown.
 */
public class InappropriatePatternDataError extends Error {
  public InappropriatePatternDataError(String classname, String functionname, String expected) {
