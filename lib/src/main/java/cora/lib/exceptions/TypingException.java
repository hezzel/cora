...
/**
 * A TypingException is thrown as part of parsing, when a user-inputted term cannot be typed as
 * expected.
 */
public class TypingException extends ParserException {
  /** Thrown when a term has an unexpected type. */
